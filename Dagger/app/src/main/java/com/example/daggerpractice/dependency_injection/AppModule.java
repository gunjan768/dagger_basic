...
public class AppModule
{
    ...
    // application object using @BindsInstance annotation when the AppComponent is created. Because we have this Application object so we can
    // access it inside this module (inside this module and we added this module to the AppComponent @Component annotation).
    @Singleton
    @Provides
    ...
    // will do that it will find it in each and every module inside this app. As we have defined it inside this module just above of it.
    @Singleton
    @Provides
