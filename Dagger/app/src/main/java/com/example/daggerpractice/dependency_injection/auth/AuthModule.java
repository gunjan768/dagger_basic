...
//    @AuthScope
    ...
    // (See ActivityBuilderModule.java class) which is in return is the subComponent of the AppComponent. And inside the AppComponent, AppModule.java
    // is defined and inside that AppModule.java class, our Retrofit instance is defined.
//    @AuthScope
    @Provides
