...
public interface AppComponent extends AndroidInjector<BaseApplication>
{
    ...
    interface Builder
    {
        // @BindsInstance is something you can use if you want to bind the particular object or particular instance of an object to the component at the
        // time of it's construction.
        @BindsInstance
