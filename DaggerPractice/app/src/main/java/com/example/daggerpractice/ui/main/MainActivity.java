    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem)
    {
        switch (menuItem.getItemId())
        {
            case R.id.nav_profile :
            {
                ...
                // If we use the old way of displaying the fragment using getSupportFragmentManager() ..... we have to manage everything like backStack
                // etc. But in this new way we don't need to do anything as everything is taken care. We first find the nav controller ( i.e
                //  FragmentContainer ) using ID and then we will search for the id associated with the fragment which we want to display
